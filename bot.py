...
Sign out
0
0 0 SirPh0enix/mugfdiu
 Code  Issues 0  Pull requests 0  Projects 0  Wiki  Insights  Settings
mugfdiu/musicbot/bot.py
0a0487a  17 days ago
@jaydenkieran jaydenkieran Merge pull request #1802 from TheerapakG/defaultparamfix
@imayhaveborkedit @jaydenkieran @TheerapakG @SexualRhinoceros @jhgg @MattBSG @AmiT177 @fjking171 @AleanaA @AutumnClove @TheOneTwelfth @sarisia @CArchetype @SternRowboat @rnegrin90 @p0thi @nkpoid @khoanguyen96 @EndenDragon @itsTheFae @Hybris95 @eDavidT @Sieabah
     
2939 lines (2288 sloc)  123 KB
import os
import sys
import time
import shlex
